...
/***/ function(module, exports, __webpack_require__) {
	...
	var headerHtml = __webpack_require__(6);
	$(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var footerHtml = __webpack_require__(8);
	$(function () {
...
/***/ function(module, exports) {
	...
	module.exports = "<p>This is footer</p>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	;(function (MyAppHome, undefined) {
	    var homeHtml = __webpack_require__(10);
	    var teachersTmp = __webpack_require__(11);
	    var pcp = __webpack_require__(14);
...
/***/ function(module, exports) {
	...
	module.exports = "<h1>This is home page!</h1>\n<h3>Here is the teachers' list</h3>\n\n<ul id=\"teachers\">\n    \n</ul>";

/***/ },
/* 11 */
/***/ function(module, exports, __webpack_require__) {

	var nunjucks = __webpack_require__(12);
	var env;
	...
	(function() {(nunjucks.nunjucksPrecompiled = nunjucks.nunjucksPrecompiled || {})["_app/views/home/_teachers.tpl"] = (function() {
	...
	frame = frame.push();
	var t_3 = runtime.contextOrFrameLookup(context, frame, "teachers");
	if(t_3) {var t_2 = t_3.length;
	for(var t_1=0; t_1 < t_3.length; t_1++) {
	var t_4 = t_3[t_1];
	frame.set("teacher", t_4);
	...
	output += " -------- age: ";
	output += runtime.suppressValue(runtime.memberLookup((t_4),"age"), env.opts.autoescape);
	output += "</li>\n";
	;
	}
	}
	...
	module.exports = shim(nunjucks, env, nunjucks.nunjucksPrecompiled["_app/views/home/_teachers.tpl"] , dependencies)
	            ...
	            $("#dataTable").jqxDataTable({
	                ...
	                columns: [{
	                    ...
	                    cellsRenderer: function cellsRenderer(row, column, value, rowData) {
	                        //在需要使用模版的地方先将模版引入进来
	                        var tmp = __webpack_require__(16);
...
/***/ function(module, exports) {
	...
	module.exports = "<div id=\"dataTable\"></div>\n<script src='//res.wisedu.com/fe_components/bh.js'></script>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function() {(nunjucks.nunjucksPrecompiled = nunjucks.nunjucksPrecompiled || {})["_app/views/pcProducts/_pcList.tpl"] = (function() {
	function root(env, context, frame, runtime, cb) {
	var lineno = null;
	var colno = null;
	var output = "";
	...
	output += "<div>\n    ";
	frame = frame.push();
	var t_3 = runtime.contextOrFrameLookup(context, frame, "laptops");
	if(t_3) {var t_2 = t_3.length;
	for(var t_1=0; t_1 < t_3.length; t_1++) {
	var t_4 = t_3[t_1];
	frame.set("laptop", t_4);
	frame.set("loop.index", t_1 + 1);
	frame.set("loop.index0", t_1);
	frame.set("loop.revindex", t_2 - t_1);
	frame.set("loop.revindex0", t_2 - t_1 - 1);
	...
	frame.set("loop.last", t_1 === t_2 - 1);
	frame.set("loop.length", t_2);
	output += "\n        <div style='float: left; width: 210px; overflow: hidden; white-space: nowrap; height: 265px;'>\n            <div style='margin: 5px; margin-bottom: 3px;'>\n                <img width=160 height=120 style=\"display: block;\" src=\"";
	output += runtime.suppressValue(runtime.memberLookup((t_4),"img"), env.opts.autoescape);
	...
	output += "</div>\n                <div>RAM: ";
	output += runtime.suppressValue(runtime.memberLookup((t_4),"ram"), env.opts.autoescape);
	output += "</div>\n                <div>HDD: ";
	output += runtime.suppressValue(runtime.memberLookup((t_4),"hdd"), env.opts.autoescape);
	output += "</div>\n                <div>CPU: ";
	output += runtime.suppressValue(runtime.memberLookup((t_4),"cpu"), env.opts.autoescape);
	output += "</div>\n                <div>Display: ";
	...
	module.exports = shim(nunjucks, env, nunjucks.nunjucksPrecompiled["_app/views/pcProducts/_pcList.tpl"] , dependencies)
